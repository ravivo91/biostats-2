...
tabled <- kable(x=data_stack, col.names = c('Mean', 'Winsorized Mean', 'Median', 'Standard Deviation', 'Coefficient of Variance'))
tabled
tabled %>% kable_styling()
