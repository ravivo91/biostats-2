...
re_datLong <- melt(re_dat, id.vars = c("bird", "condition"), variable.name = "Timing", value.name = "Refractive Error")
...
re_datLonger <- melt(re_datSub, variable.name = "cond", value.name = "RE")
...
write.csv(dTransform, file = "data_ex3.csv")

Ex3_data <- read.csv('data_ex3.csv')
