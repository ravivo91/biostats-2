...
#### Lecture 7 - Psychometric Function fitting ####
library(R.matlab)
library(tidyverse)
...
# Why make life difficult? Isn't this just the same as NHST? From this procedure we get the likelihood of our nullInterval our alt. interval generated our data. We're not a using conventional cut-off (i.e., alpha) but can quanitify the possibilties. (NB ... but some folks want to categorize so Bayes factors as more interesting... life goes on... ) 
